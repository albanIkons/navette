		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Navette",
									"targetURL": "#npmnavettenavette-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"npmnavettenavette-display": {
								"semanticObject": "npmnavettenavette",
								"action": "display",
								"description": "Appplication Navette",
								"title": "Navette",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=npmnavette.navette",
									"url": sap.ui.require.toUrl("npmnavette/navette")
								}
							}
						}
					}
